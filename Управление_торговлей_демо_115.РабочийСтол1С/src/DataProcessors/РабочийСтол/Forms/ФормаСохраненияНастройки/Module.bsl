...
Функция СохранитьНаСервере()
	...
	Попытка
		...
		РегистрыСведений.РБ_НастройкиРабочегоСтола.ЗаписатьНастройкиРабочегоСтола(ТекПользователь, Настройка);
		Если МетодСохранения = 1 Тогда
			РегистрыСведений.РБ_НастройкиРабочегоСтола.ЗаписатьНастройкиРабочегоСтола(СписокПользователей(), Настройка);
		КонецЕсли;
